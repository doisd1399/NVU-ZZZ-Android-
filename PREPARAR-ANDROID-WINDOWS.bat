...
echo.
echo Executando certificacao funcional R3.34-PC-HF60 Terminal Safe (base HF59 Sync Safe)...
...
echo.
echo Verificando paridade do Web R3.34-PC-HF60 com os assets Android...
...
echo R3.34-PC-HF60 preserva HF58 Cost Safe e HF59 Sync Safe e impede que uma entrega certificada fique presa em finalizando recebimento por oscilacao de foreground, sem alterar OCR, deteccao visual, bolha ou selecao de frete.
echo Regra preservada: lista de fretes certificada reaberta encerra o contexto anterior e inicia um novo ciclo de selecao.
echo As Firebase Functions permanecem byte-a-byte iguais ao HF58 ja publicado. HF60 nao exige novo deploy de Functions nem novo deploy Web/Netlify.
echo Para producao, gere uma RELEASE assinada com a mesma keystore oficial. Veja: COMANDOS-R3.34-HF60-RELEASE-WINDOWS.txt
echo ============================================================
pause
exit /b 0
