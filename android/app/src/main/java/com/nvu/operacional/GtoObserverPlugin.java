...
public class GtoObserverPlugin extends Plugin {
    ...
    private JSObject buildStatus() {
        ...
        status.put("gtoBackgroundQueuePending", GtoAutoTripSync.hasQueuedOtherThanForDriver(context, statusSessionId, statusUid));
        ...
        status.put("backgroundSyncPendingSessionId", prefs.getString("backgroundSyncPendingSessionId", ""));
        status.put("backgroundSyncPendingDetail", prefs.getString("backgroundSyncPendingDetail", ""));
        status.put("backgroundSyncLastSessionId", prefs.getString("backgroundSyncLastSessionId", ""));
        status.put("backgroundSyncLastTripId", prefs.getString("backgroundSyncLastTripId", ""));
        status.put("backgroundSyncLastAckAt", prefs.getLong("backgroundSyncLastAckAt", 0L));
