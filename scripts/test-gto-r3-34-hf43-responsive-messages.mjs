...
const syncingMsg = service.indexOf('"Viagem concluída, enviando dados automaticamente..."', autoFinalize);
ck("automatic completion communicates sending before backend ACK without claiming success", autoFinalize >= 0 && syncingMsg > autoFinalize && enqueue > syncingMsg);
...
ck("normal happy-path status labels are concise", service.includes('"Frete selecionado · confirmando dados"') && service.includes('return "Viagem concluída ✓ · enviando automaticamente";'));
