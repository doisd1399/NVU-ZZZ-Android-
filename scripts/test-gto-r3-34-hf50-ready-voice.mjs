...
ck(
  'workflow verifies ready voice inside built APK',
  workflow.includes('nvu_ready_voice_pt_br') ||
    workflow.includes('python3 scripts/verify-hf60-voice-apk.py')
);
...
const invariantFiles = [
  ...
  ['projection continuity policy matches approved HF55+ baseline', 'android/app/src/main/java/com/nvu/operacional/GtoProjectionContinuityPolicy.java', '10982726b94836126c35ffd0d000629ffd275bfcdd158c12539ffea71a534bd6'],
